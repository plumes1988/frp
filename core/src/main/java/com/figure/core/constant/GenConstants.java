...
public class GenConstants {
     ...
     * 页面不需要编辑字段
     */
    public static final String[] COLUMN_NAME_NOT_EDIT = {"id", "createUserId", "createTime", "del_flag"};
    /**
     * 页面不需要显示的列表字段
     */
    public static final String[] COLUMN_NAME_NOT_LIST = {"id", "createUserId", "createTime", "del_flag", "updateUserId", "updateTime"};
    /**
     * 页面不需要查询字段
     */
    public static final String[] COLUMN_NAME_NOT_QUERY = {"id", "createUserId", "createTime", "del_flag", "updateUserId", "updateTime", "remark"};
