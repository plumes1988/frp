...
public class RecordServiceInfoList extends BaseModel {

    /**
     * 收录集群ID
     */
    @ApiModelProperty("收录集群ID")
    ...
    @TableField(exist = false)
    private Integer clusterTotalResources;

    @TableField(exist = false)
    private Integer clusterUsedResources;
}